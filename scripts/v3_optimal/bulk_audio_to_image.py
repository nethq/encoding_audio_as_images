...
if len(sys.argv) != 4:
    print("Usage: python script.py <path_to_wav_folder> <path_to_output_base_folder> <image_size>")
    sys.exit(1)

path_to_wav_folder = sys.argv[1]
path_to_output_base_folder = sys.argv[2]
image_size = int(sys.argv[3])

#call the script on all files in the folder
for file in os.listdir(path_to_wav_folder):
    audio_file_path = os.path.join(path_to_wav_folder, file)
    print(f"Converting {audio_file_path} to images...")
